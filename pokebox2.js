...
var modclose = document.getElementById('close'); 
function sideMenu() {
...
function showModal(e) {
    document.getElementById('modal-show').removeAttribute('class','dispcls');
    console.log(document.getElementById('modal-show'));
...
function closeModal(){
    document.getElementById('modal-show').setAttribute('class','dispcls');
    console.log(document.getElementById('modal-show'));
...
var key = document.getElementById('search_poke').value;
    ...
    var item =  cards.getElementsByClassName('card');
